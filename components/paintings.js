...
export const paintings = [
  ...
  // hallway
  { url: '/artworks/21.jpg', width: 10, height: 5, info: {title: 'Van Gogh', artist: 'Vincent van Gogh', description: 'This is one of the masterpieces by Vincent van Gogh, showcasing his unique style and emotional honesty.', year: '2021'}, position: { x: 50, y: 4, z: 7 }, rotation: Math.PI }, // hallaway right?  // 21 
  { url: '/artworks/22.jpg', width: 10, height: 5, info: {title: 'Van Gogh', artist: 'Vincent van Gogh', description: 'This is one of the masterpieces by Vincent van Gogh, showcasing his unique style and emotional honesty.', year: '2021'}, position: { x: 30, y: 4, z: 7 }, rotation: Math.PI }, // hallway right
  { url: '/artworks/23.jpg', width: 10, height: 5, info: {title: 'The Persistence of Memory', artist: 'Salvador Dalí', description: 'This iconic surrealist painting by Salvador Dalí depicts a dreamlike landscape where melting clocks drape over strange objects, symbolizing the fluidity and distortion of time. The eerie yet captivating scene challenges the viewer’s perception of reality and remains one of Dalí’s most celebrated works.', year: '1931'}, position: { x: 50, y: 4, z: -7 }, rotation: 0 }, // hallway left 
  { url: '/artworks/24.jpg', width: 10, height: 5, info: {title: 'Van Gogh', artist: 'Vincent van Gogh', description: 'This is one of the masterpieces by Vincent van Gogh, showcasing his unique style and emotional honesty.', year: '2021'}, position: { x: 30, y: 4, z: -7 }, rotation: 0 }, //hallway left  // lady 
];
