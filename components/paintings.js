...
export const paintings = [
  { url: '/artworks/0.jpg', width: 10, height: 5, info: {title: 'Van Gogh', artist: 'Vincent van Gogh', description: 'This is one of the masterpieces by Vincent van Gogh, showcasing his unique style and emotional honesty.', year: '2021'}, position: { x: -8.5, y: 5, z: -19.99 }, rotation: 0 },
  ...
  { url: '/artworks/8.jpg', width: 10, height: 5, info: {title: 'Van Gogh', artist: 'Vincent van Gogh', description: 'This is one of the masterpieces by Vincent van Gogh, showcasing his unique style and emotional honesty.', year: '2021'}, position: { x: 80, y: 5, z: -39.99 }, rotation: 0 }, // correct // left
  ...
  { url: '/artworks/12.jpg', width: 10, height: 9, info: {title: 'Van Gogh', artist: 'Vincent van Gogh', description: 'This is one of the masterpieces by Vincent van Gogh, showcasing his unique style and emotional honesty.', year: '2021'}, position: { x: 114.99, y: 3, z: -13 }, rotation: -Math.PI / 2 },
  { url: '/artworks/13.jpg', width: 7, height: 10, info: {title: 'Van Gogh', artist: 'Vincent van Gogh', description: 'This is one of the masterpieces by Vincent van Gogh, showcasing his unique style and emotional honesty.', year: '2021'}, position: { x: 114.99, y: 3, z: 13 }, rotation: -Math.PI / 2 }, // this should be big back wall room 2
  ...
  { url: '/artworks/21.jpg', width: 10, height: 5, info: {title: 'Van Gogh', artist: 'Vincent van Gogh', description: 'This is one of the masterpieces by Vincent van Gogh, showcasing his unique style and emotional honesty.', year: '2021'}, position: { x: 43.75, y: 5, z: 7.49 }, rotation: Math.PI },
  { url: '/artworks/22.jpg', width: 10, height: 5, info: {title: 'Van Gogh', artist: 'Vincent van Gogh', description: 'This is one of the masterpieces by Vincent van Gogh, showcasing his unique style and emotional honesty.', year: '2021'}, position: { x: 43.75, y: 5, z: 7.49 }, rotation: Math.PI },
  { url: '/artworks/23.jpg', width: 10, height: 5, info: {title: 'Van Gogh', artist: 'Vincent van Gogh', description: 'This is one of the masterpieces by Vincent van Gogh, showcasing his unique style and emotional honesty.', year: '2021'}, position: { x: 43.75, y: 5, z: -7.49 }, rotation: 0 },
  { url: '/artworks/24.jpg', width: 10, height: 5, info: {title: 'Van Gogh', artist: 'Vincent van Gogh', description: 'This is one of the masterpieces by Vincent van Gogh, showcasing his unique style and emotional honesty.', year: '2021'}, position: { x: 43.75, y: 5, z: -7.49 }, rotation: 0 },
];
