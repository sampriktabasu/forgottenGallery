...
export function addPaintings(scene) {
  const paintings = [
    ...
    { url: '/artworks/1.jpg', width: 10, height: 5, info: {title: 'Van Gogh', artist: 'Vincent van Gogh', description: 'This is one of the masterpieces by Vincent van Gogh, showcasing his unique style and emotional honesty.', year: '2021'}, position: { x: 8.5, y: 5, z: -19.99 } },
